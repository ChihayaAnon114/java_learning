...
public class Student {
    ...
    Student(){
        ...
        this.name="新同学";this.gender="未知";this.birthday=default_birthday;
    }
    Student(String n,String g,int y,int m,int d){
        this.name=n;this.gender=g;this.birthday=new M_date(y,m,d);
    }
    public void show(){
